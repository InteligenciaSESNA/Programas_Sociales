...
def get_info(feature=None):
    ...
    if not feature:
        return [
            ...
            dmc.Center(html.Img(id='fert_image', src='../assets/entidades/Nacional.png', width="65", height="65")),
            html.H4("{}".format("Nacional"))]
    ...
    return [
            ...
            dmc.Center(html.Img(id='fert_image', src='../assets/entidades/'+ str(feature["properties"]["name"]) +'.png', width="65", height="65")),
            html.H4("{}".format(feature["properties"]["name"]))
          ]
...
def get_info2(feature=None):
    ...
    if not feature:
        return html.Center([
            ...
            dbc.Col(dmc.Text('Nacional', id='fert_nacional', align="center", weight=700), style={'fontSize':40}),
        ])
    #[
    ...
    # valores a nivel estatal
    return html.Center([
            dbc.Col(html.Img(id='fert_image', src='../assets/entidades/'+ str(feature["properties"]["name"]) +'.png', width="65", height="90")),
...
# 
# Information
info = html.Div(children=get_info(), id="fert_info", className="info",
