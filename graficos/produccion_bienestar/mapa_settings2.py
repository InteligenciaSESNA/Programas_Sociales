...
def get_info(feature=None):
    ...
    if not feature:
        return [
            ...
            dmc.Center(html.Img(id='prod_image', src='../assets/entidades/Nacional.png', width="65", height="65"))]
    ...
    return [
            ...
            dmc.Center(html.Img(id='prod_image', src='../assets/entidades/'+ str(feature["properties"]["name"]) +'.png', width="65", height="65")),
          ]
...
def get_info2(feature=None):
    ...
    if not feature:
        return html.Center([
            ...
            dbc.Col(dmc.Text('Nacional', id='prod_nacional', align="center", weight=700), style={'fontSize':40}),
        ])
    #[
    ...
    # valores a nivel estatal
    return html.Center([
            dbc.Col(html.Img(id='prod_image', src='../assets/entidades/'+ str(feature["properties"]["name"]) +'.png', width="65", height="90")),
...
# 
# Information
info = html.Div(children=get_info(), id="prod_info", className="info",
