...
seccion4 = html.Div([
    dbc.Row([
        ...
        dbc.Col([
            dmc.Button(
                    "Instrucciones: ",
                    id="prod_transition-instrucciones-btn",
                    variant="subtle",
            ...
            dbc.Fade(
                ...
                id="prod_transition-instrucciones",
                is_in=False,
                appear=False,
                 ...
                 #dmc.Anchor(
                    ...
                    dbc.Modal([
                            ...
                            dbc.ModalBody(html.Div(children=[
                                ], id='prod_reglas-operacion', style={'paddingLeft':'2.5rem', 'paddingRight':'2.5rem'})
                            , style={'backgroundColor':'#2a3240'}),
                            dbc.ModalFooter(
                                dbc.Button(
                                    "Cerrar", id="prod_close", className="ms-auto", outline=False, color="dark", n_clicks=0
            ...
            html.Div([
                #dmc.Anchor(
                    dmc.Button("Descarga xlsx",
                            id="prod_dowload_xlsx",
                            variant="subtle",
                            leftIcon=DashIconify(icon="eos-icons:database"),
                            color="white",
                            n_clicks=0) , #href='#'),
                    dcc.Download(id="prod_download-db-xlsx"),
            ], style={'display': 'inline-block'}),
            dmc.Divider(orientation="vertical", style={"height": 30}),
            html.Div([
                dmc.Button(
                    "...",
                    id="prod_fade-transition-button",
                    variant="subtle",
                    #leftIcon=DashIconify(icon="eos-icons:database"),
                    color="white",
                    n_clicks=0
