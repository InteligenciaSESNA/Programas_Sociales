...
"""
    ...
    La sección contiene información sobre los montos ejercidos en el programa de
precios de garantía, así como un gráfico de barras para facilitar la interpretación 
de los datos. 
