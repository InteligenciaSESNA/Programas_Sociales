        ...
        # Filtros
            dmc.Group([
                dmc.SimpleGrid(cols=2, children=[
                    ...
                    html.Div([
                        dmc.Text('2023', id='prod_anio_filtro1', size=14,weight=700, color="#4e203a", align="left", style={'padding':'0rem', 'margin':'0rem'}),    
                        dmc.Text('Arroz', id='prod_producto_filtro1', weight=700, size=14, color="#4e203a", align="left", style={'padding':'0rem', 'margin':'0rem'}),
                    ]),
            ...
            dmc.Card([
                    html.Div(
                        id="prod_content-capas-criterios",
...
seccion6 = html.Div([
        dbc.Row([
            dbc.Col([
                    html.Div([
                     ], id="prod_mapa", style={"width": "100%", "height":'100%'}
                    ),   # style={'height':'100vh'}
