...
############             2020 - Leche
ro_2020_leche = html.Div(children=[
                        # Título                                # TÍTULO
                        #dmc.Text("Reglas de Operación (Trigo-2020)", color='white', weight=700, style={'fontSize':24} ),
                        html.Br(),
                            # spoiler (text)
...
############             2020 - Arroz
ro_2021_arroz = html.Div(children=[
                        # Título                                # TÍTULO
                        #dmc.Text("Reglas de Operación (Trigo-2020)", color='white', weight=700, style={'fontSize':24} ),
                        html.Br(),
                            # spoiler (text)
...
############             2019 - Leche
ro_2021_leche = html.Div(children=[
                        # Título                                # TÍTULO
                        #dmc.Text("Reglas de Operación (Trigo-2020)", color='white', weight=700, style={'fontSize':24} ),
                        html.Br(),
                            # spoiler (text)
...
##########################   2022 - Maíz  ############################
######################################################################
ro_2022_maiz = html.Div(children=[
                        # Título                                # TÍTULO
                        #dmc.Text("Reglas de Operación (Trigo-2020)", color='white', weight=700, style={'fontSize':24} ),
                        html.Br(),
                            # spoiler (text)
...
##########################   2020 - Frijol  ####################
ro_2022_frijol = html.Div(children=[
...
############             2020 - Trigo
ro_2022_trigo = html.Div(children=[
                        # Título                                # TÍTULO
                        #dmc.Text("Reglas de Operación (Trigo-2020)", color='white', weight=700, style={'fontSize':24} ),
                        html.Br(),
                        # spoiler (text)
...
############             2022 - Arroz
ro_2022_arroz = html.Div(children=[
...
############             2019 - Leche
ro_2022_leche = html.Div(children=[
                        html.Br(),
                        # spoiler (text)
                        dmc.Spoiler(
                        showLabel="Continuar leyendo",
