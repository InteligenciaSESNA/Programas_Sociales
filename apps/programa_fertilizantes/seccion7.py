...
from graficos.programa_fertilizantes.mapa_settings import get_info
...
def get_card_poblacion_indigena(app):
    ...
    @app.callback(# 'click_feature
        Output('fert_resumen-poblacion-indigena', 'children'),
...
def get_card_poblacion_beneficiaria_img(app):
    ...
    @app.callback(# 'click_feature
            Output('fert_image-poblacion_beneficiaria', 'src'),
...
def get_card_poblacion_beneficiaria_texto(app):
    ...
    @app.callback(# 'click_feature
            Output('fert_resumen_texto_poblacion_beneficiaria', 'children'),
            Input('fert_beneficiarios-opciones', 'value'),
        )
...
def get_card_poblacion_beneficiaria(app):
    ...
    @app.callback(
            Output('fert_resumen-poblacion_beneficiaria', 'children'),
            Input('fert_submit-button', 'n_clicks'),
            Input("fert_states", "click_feature"),
            Input('fert_beneficiarios-opciones', 'value'),
            Input("fert_transfer-list-simple", "value"),
...
def get_card_monto_promedio(app):
    ...
    @app.callback(
            Output('fert_resumen-monto-promedio', 'children'),
            Input('fert_submit-button', 'n_clicks'),
            Input("fert_states", "click_feature"),
            Input("fert_transfer-list-simple", "value"),
            State('fert_producto', 'value'),
...
def get_card_poblacion_mujeres(app):
    ...
    @app.callback(
            Output('fert_resumen-poblacion-mujeres', 'children'),
            Input('fert_submit-button', 'n_clicks'),
            Input("fert_states", "click_feature"),
            Input("fert_transfer-list-simple", "value"),
            State('fert_producto', 'value'),
