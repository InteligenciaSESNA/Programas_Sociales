...
def get_card_centros_acopio(app):
    ...
    @app.callback(# 'click_feature
        Output('resumen-centros_acopio', 'children', allow_duplicate=True),
...
def get_card_poblacion_beneficiaria_img(app): 
    ...
    @app.callback(# 'click_feature
            Output('image-poblacion_beneficiaria', 'src', allow_duplicate=True),
...
def get_card_poblacion_beneficiaria_texto(app): 
    ...
    @app.callback(# 'click_feature
            Output('resumen_texto_poblacion_beneficiaria', 'children', allow_duplicate=True),
            Input('beneficiarios-opciones', 'value'),
            prevent_initial_call=True,
        )
...
def get_card_poblacion_beneficiaria(app): 
    ...
    @app.callback(
            Output('resumen-poblacion_beneficiaria', 'children', allow_duplicate=True),
            Input('submit-button', 'n_clicks'),
            Input("states", "click_feature"),
            Input('beneficiarios-opciones', 'value'),
            Input("transfer-list-simple", "value"),
...
def get_card_volumen_incentivado(app): 
    ...
    @app.callback(
            Output('resumen-volumen_incentivado_total', 'children',allow_duplicate=True),
            Input('submit-button', 'n_clicks'),
            Input("states", "click_feature"),
            Input("transfer-list-simple", "value"),
            State('producto', 'value'),
...
def get_card_volumen_incentivado_promedio(app): 
    ...
    @app.callback(
            Output('resumen-volumen_incentivado_promedio', 'children', allow_duplicate=True),
            Input('submit-button', 'n_clicks'),
            Input("states", "click_feature"),
            Input("transfer-list-simple", "value"),
            State('producto', 'value'),
